...
export default function Recipes1(){
  return(
    <div>
      <BlogPostPage title="3 Recipes from My Mom to You: Part 1" date="July 10, 2020" writers="Seungbin Kang. Edited by Tanae Rao and Jordanne Stewart" artists="Alice Schroeder" img={recipe1}/>
