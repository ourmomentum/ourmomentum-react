...
export default function Brightside(){
  return(
      <div>
      <BlogPostPage title="On the Bright Side" date="July 24, 2020" writers="Atrayee Dutt. Edited by Eden Gringart and Jordanne Stewart" artists="Thanh Le" img={brightSide} link='/blog/brightside'/>
